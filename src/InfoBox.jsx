...
export default function InfoBox({info}){
    const INIT_URL = "https://images.unsplash.com/photo-1580049904360-a9c3b79f86ff?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
    ...
    return(
      ...
      <CardContent>
        ...
        <Typography variant="body2" color="text.secondary" component={"span"}>
         ...
         <p>The weather can be description as <i>{info.weather} </i>and feels like {info.feelslike}&deg;C</p>
        </Typography>
      </CardContent>
    </Card>
    </div>
